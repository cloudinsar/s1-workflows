...
```bash
docker build -t openeo_insar:1.6 . -f OpenEO_Dockerfile
/usr/bin/time -v docker run -it -v /home/ubuntu:/root -e AWS_ACCESS_KEY_ID=$AWS_ACCESS_KEY_ID -e AWS_SECRET_ACCESS_KEY=$AWS_SECRET_ACCESS_KEY --rm openeo_insar:1.6 python3 /src/OpenEO_insar_coherence.py
```
