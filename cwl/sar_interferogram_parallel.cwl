...
# Example on how to run locally: cwltool --debug --tmpdir-prefix=$HOME/tmp/ --force-docker-pull --leave-container --leave-tmpdir --no-read-only --parallel --preserve-environment=AWS_ENDPOINT_URL_S3 --preserve-environment=AWS_ACCESS_KEY_ID --preserve-environment=AWS_SECRET_ACCESS_KEY cwl/sar_interferogram_parallel.cwl sar/example_inputs/input_dict_2024_vv.json
cwlVersion: v1.2
$graph:
