    ...
    steps:
      scatter_node_step:
        inputs:
          json_input:
            type: File
            default: "insar_pairs_inputs.json"
        scatter: [ InSAR_pairs ]
    ...
    steps:
      ...
      gatherer_node_step2:
        in:
          ...
          polarization: main/polarization
          sub_swath: main/sub_swath
        out: [ scatter_node_out1 ]
        run: "#scatter_node"
      gatherer_node_step3:
        in:
          simple_stac_merge_in1: gatherer_node_step2/scatter_node_out1
